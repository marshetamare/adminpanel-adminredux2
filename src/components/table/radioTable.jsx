...
import NewRadioForm from "../../pages/radio/NewRadioForm";
      ...
      <Table sx={{ minWidth: 650 }} aria-label="simple table">
        <TableHead>
          <TableRow>
            ...
            <TableCell className="tableCell">Radio Logo</TableCell>
            <TableCell className="tableCell"> Radio Name</TableCell>
            <TableCell className="tableCell"> Radio frequency</TableCell>
            <TableCell className="tableCell"> Radio Url</TableCell>
            ...
            <TableRow key={row.id}>
              ...
              <TableCell className="tableCell">
                <div className="cellWrapper">
                  <img src={row.station_cover} alt="" className="image" />
                 
               

                </div>
              </TableCell>
              <TableCell className="tableCell">{row.station_name}</TableCell>
              <TableCell className="tableCell">{row.station_frequency}</TableCell>
              <TableCell className="tableCell">{row.station_url}</TableCell>
             
              
              <TableCell className="tableCell">
              <Link to={"/radio/" + row.id} style={{ textDecoration: "none" }}>
